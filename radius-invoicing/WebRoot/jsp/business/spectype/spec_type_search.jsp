  ...
  $(function (){
  	...
  	$('#spec_type_search_query_btn').on('click',function(){
  		...
  		spec_type_grd_spec_type_info_grid.datagrid('load',{
			...
			quantityEuUnit	:$('#spec_type_search_spec_type_info_equivalent_unit').val()//折合数量/规格单位
  		});
  	});
  	
  	//添加规格信息
  	$('#spec_type_search_add_btn').on('click',function(){
  	});
		...
		<tr>
			...
			<td rowspan="2">
				...
				<div style="float: left;margin-left: 10px;margin-top: 5px;">
					<a id="spec_type_search_add_btn"  href="#" class="easyui-linkbutton" data-options="iconCls:'icon-mini_add'" plain="true">添加</a>
				<div>
			</td>
		</tr>
	</table>
