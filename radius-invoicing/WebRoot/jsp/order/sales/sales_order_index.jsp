...
<body>
	<div id="sales_order_layout" class="easyui-layout" style="width:100%;height:100%;" fit="true">
	    ...
	    <div data-options="region:'center',split:true" fit="true" border="false">
    		...
    		<div title="订单明细" fit="true" style="margin-top: 5px;">
    			<div style="padding:0px 15px 0px 15px;">
    				<jsp:include flush="true" page="sales_order_goods_detail.jsp"></jsp:include>
    			</div>
    			<div>
    				<jsp:include flush="true" page="sales_order_goods_detail_grd.jsp"></jsp:include>
    			</div>
	        </div>
	        <div title="订单条款" fit="true" style="padding:5px 15px 0px 15px;">
    			<jsp:include flush="true" page="sales_order_terms.jsp"></jsp:include>
	        </div>
    		<div title="订单备注" fit="true" style="padding:5px 15px 0px 15px;">
    			<jsp:include flush="true" page="sales_order_memo.jsp"></jsp:include>
	        </div>
    		<div title="销售合同商品列表" fit="true" style="padding:5px 15px 0px 15px;">
    			<jsp:include flush="true" page="sales_order_sales_contract_goods_detail.jsp"></jsp:include>
	        </div>
    		<div title="报价记录" fit="true" style="padding:5px 15px 0px 15px;">
    			<jsp:include flush="true" page="sales_order_quoted.jsp"></jsp:include>
	        </div>
    	</div>
	    </div>
	</div>
	<jsp:include flush="true" page="sales_order_open.jsp"></jsp:include>
</body>
</html>