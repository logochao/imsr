    ...
    <div data-options="region:'center',split:true" fit="true" border="false">
    	<div id="purchase_order_index_tabs"  data-options="split:true" fit="true" border="false">
    		<div title="订单明细" fit="true" style="margin-top: 5px;">
                <jsp:include flush="true" page="purchase_order_goods_detail.jsp"></jsp:include>
	        </div>
    		...
    		<div title="询价记录" fit="true" style="padding:5px 15px 0px 15px;">
    			<jsp:include flush="true" page="purchase_order_inquiry.jsp"></jsp:include>
	        </div>
    		<div title="合单明细" fit="true" style="padding:5px 15px 0px 15px;">
    			<jsp:include flush="true" page="purchase_order_merger_order_detail.jsp"></jsp:include>
	        </div>
    	</div>
    </div>
    <jsp:include flush="true" page="purchase_order_open.jsp"></jsp:include>
</div>
</body>
</html>