...
<table class="table" style="width: 100%;">
	<tr>
		<th>合同编号</th>
		<td><input class="easyui-validatebox" style="background:#eee;width: 150px;border:1px solid #95B8E7;" id="constract_sales_sale_base_id" type="text" readonly="readonly" name="name" data-options="" value="${salesContract.id}"/></td>
		<th>状态</th>
	...
	<tr>
		<th>客户</th>
		<td colspan="5">
			<input  type="text" name="customerName" id="contract_sales_base_customer_name" style="width: 300px;border:1px solid #95B8E7;" name="name" readonly="readonly" data-options=""/> 
	...
	<tr>
		<th>联系人</th>
		<td>
			<input id="contract_sales_base_link_man" style="border:1px solid #95B8E7;" class="easyui-validatebox" type="text" name="man" data-options=""/>
		...
		<th>办公电话</th>
		<td><input class="easyui-validatebox" type="text" name="tel" id="contract_sales_base_link_tel" style="border:1px solid #95B8E7;" data-options=""/></td>
		<th>手机号码</th>
		<td><input class="easyui-validatebox" type="text" name="mobile" id="contract_sales_base_link_mobile" style="border:1px solid #95B8E7;" data-options=""/></td>
		<th>传真</th>
		<td><input class="easyui-validatebox" type="text" name="fax" id="contract_sales_base_link_fax" style="border:1px solid #95B8E7;" data-options=""/></td>
	</tr>
	<tr>
		<th>送货地址</th>
		...
		<th>业务员</th>
		<td>
			<input class="easyui-validatebox" type="text" name="salesMan" style="border:1px solid #95B8E7;" data-options=""/>
			<a id="btn" href="#" class="easyui-linkbutton" plain="true"><font style="font-size:3ex">...</font></a>
		</td>
		<th colspan="2" style="text-align: center;"><input type="checkbox" id="contract_sales_base_checkbox" style="border:1px solid #95B8E7;" onclick="javascript:contractSalesBaseCheckboxClick(this);" value="0" />转保函付款申请</th>
	</tr>
	<tr>
		<th>合同类型</th>
...
<div id="sales_base_custmer_dialog" style="display: none;">
	...
	<fieldset>
			...
			<table class="table" style="width: 100%;">
				<tr>
					<th>客户名称(关键字)</th>
					<td><input name="customer_name" id="sales_base_customer_name" style="border:1px solid #95B8E7;"/></td>
					<th>联系人</th>
					<td><input name="customer_link" id="sales_base_customer_link" style="border:1px solid #95B8E7;"/></td>
				</tr>
				<tr>
					<th>联系电话</th>
					<td><input name="customer_link_tel" id="sales_base_customer_link_tel" style="border:1px solid #95B8E7;"/></td>
					<td colspan="2">
...
<div id="contract_sales_base_custmer_link_man" style="display: none;">
	...
	<fieldset>
			...
			<table class="table" style="width: 100%;">
				<tr>
					<th>联系人</th>
					<td><input id="contract_sales_base_custmer_link_man_" style="border:1px solid #95B8E7;"/></td>
					<th>联系电话</th>
					<td><input id="contract_sales_base_custmer_link_tel_" style="border:1px solid #95B8E7;"/></td>
					<td>
						<div style="float: left;">
