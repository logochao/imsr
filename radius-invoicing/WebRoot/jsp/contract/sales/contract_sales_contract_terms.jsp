...
<!--
 ...
 function setContractSalesContractTermsTab(row_data){
	setInputElementValue($('#contract_sales_contract_terms_contract_file_id'),row_data.contractFile);//合同文件编号
 	$('#contract_sales_contract_terms_sign_time').val(row_data.signTime);//签署日期
 	$('#contract_sales_contract_terms_effivit_time').val(row_data.effectDate);//生效日期
 	$('#contract_sales_contract_terms_fail_time').val(row_data.validityDate);//有效期至
 ...
 function clearContractSalesContractTerms(){
	...
	$('#contract_sales_contract_terms_sign_time').val('');
	$('#contract_sales_contract_terms_effivit_time').val('');
	$('#contract_sales_contract_terms_fail_time').val('');
 }
//-->
</script>
<table class="table" style="width: 99.5%;">
   	<tr>
   		...
   		<th>签署日期</th>
   		<td><input id="contract_sales_contract_terms_sign_time" class="Wdate" onClick="WdatePicker()"/></td>
   		<th>生效日期</th>
   		<td><input id="contract_sales_contract_terms_effivit_time" class="Wdate" onClick="WdatePicker()"/></td>
   		<th>有效期到</th>
   		<td><input id="contract_sales_contract_terms_fail_time" class="Wdate" onClick="WdatePicker()"/></td>
   	</tr>
   	<tr>
   		<th>合同条款</th>
   		<td colspan="7">
