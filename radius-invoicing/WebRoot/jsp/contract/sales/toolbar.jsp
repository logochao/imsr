...
var contract_sales_tool_bar_save=null;
$(function(){
	//打开按钮
	...
	//打印按钮
	$('#contract_sales_toolbar_print_btn').on('click',function(){
	
	});
	
	
	//报表按钮
	$('#contract_sales_toolbar_report_btn').on('click',function(){
	
	});
	
	
	//关闭按钮
	$('#contract_sales_toolbar_close_btn').on('click',function(){
...
<div style="height: 28px;width: 30%;display:inline;padding-left:20px;">
	...
	<a id="contract_sales_toolbar_pend_btn" href="#" class="easyui-linkbutton" style="margin-left:20px;" data-options="iconCls:'icon-attach'">挂单</a>
</div>
<div style="display:inline;width: 30%;margin-left:80px;">
	<a id="contract_sales_toolbar_ok_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-true'">合同提交</a>
...
<div style="display:inline;margin-left:200px;">
	<a id="contract_sales_toolbar_close_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'">关闭</a>
</div>
