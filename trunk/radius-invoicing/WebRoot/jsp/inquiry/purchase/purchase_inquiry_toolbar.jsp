...
<div style="height: 28px;width: 30%;display:inline;padding-left:20px;">
	...
	<a id="purchase_inquiry_toolbar_pend_btn" href="#" class="easyui-linkbutton" contract_status="6001" style="margin-left:20px;" data-options="iconCls:'icon-attach'">挂单</a>
</div>
<div style="display:inline;width: 30%;margin-left:80px;">
	<a id="purchase_inquiry_toolbar_ok_btn" href="#" class="easyui-linkbutton" contract_status="6002" data-options="iconCls:'icon-save'">提交询价</a>
