...
<table class="table" style="width: 100%;">
	<tr>
		...
		<th>规格</th>
		<td colspan="3">
			<input class="easyui-validatebox" type="text" style="width: 200px;" id="contract_sales_goods_grd_form_format" validType="length[0,2]"missingMessage="请输入规格" invalidMessage="不能超过2个字符!"  data-options="required:true"/>
		</td>
		<th>单价</th>
		<td>
	...
	<tr>
		<th>折合单价</th>
		<td>
			<input class="easyui-validatebox" type="text" id="contract_sales_goods_grd_form_price_convert_unit" data-options="required:true,validType:'numberic',missingMessage:'请输入折合单价',invalidMessage:'请输入正确的格式'"/>
		</td>
		<th>数量</th>
		<td>
