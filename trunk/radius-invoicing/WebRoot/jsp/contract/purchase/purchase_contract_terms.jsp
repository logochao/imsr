...
<table class="table" style="width: 99.5%;margin-top: 10px;">
	<tr>
		...
		<th>签署日期</th>
   		<td><input id="purchase_contract_terms_sign_time" class="Wdate" onClick="WdatePicker()" style="border:1px solid #95B8E7;"/></td>
   		<th>生效日期</th>
   		<td><input id="purchase_contract_terms_effivit_time" class="Wdate" onClick="WdatePicker()" style="border:1px solid #95B8E7;"/></td>
   		<th>有效期到</th>
   		<td><input id="purchase_contract_terms_validity_time" class="Wdate" onClick="WdatePicker()" style="border:1px solid #95B8E7;"/></td>
	</tr>
	<tr>
		<th>合同条款</th>
		<td colspan="7">
