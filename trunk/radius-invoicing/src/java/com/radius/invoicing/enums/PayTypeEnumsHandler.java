 ...
 * 类说明
 */
public class PayTypeEnumsHandler implements TypeHandlerCallback {

	public Object getResult(ResultGetter getter) throws SQLException {
		Object result=null;
		if(null!=getter.getObject()){
			result=PayTypeEnums.getPayTypeEnumById(getter.getInt());
		}
		return result;
	}
	...
	public void setParameter(ParameterSetter setter, Object obj)
		...
		setter.setInt(((PayTypeEnums)obj).getId());
	}
	...
	public Object valueOf(String str) {
		...
		result=PayTypeEnums.getPayTypeEnumById(id);
		return result;
	}
