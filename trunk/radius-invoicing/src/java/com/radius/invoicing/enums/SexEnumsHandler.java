 ...
 * 类说明 性别枚举处理(ibatis)
 */
public class SexEnumsHandler implements TypeHandlerCallback {

	public Object getResult(ResultGetter getter) throws SQLException {
		Object result=null;
		if(null!=getter.getObject()){
			result=SexEnums.getSexEnumsById(getter.getInt());
		}
		return result;
	}
	...
	public void setParameter(ParameterSetter setter, Object object) throws SQLException {
		...
		* 在sqlMap中配parameterMap的属性typeHandler和sqlMapConfig中配全局typeHandler时才会触发 
		...
		setter.setInt(((SexEnums)object).getId());
	}

	public Object valueOf(String str) {
		Object result=null;
		if(null!=str&&str.length()>0){
			result=SexEnums.getSexEnumsNameById(Integer.parseInt(str));
		}
		return result;
	}
